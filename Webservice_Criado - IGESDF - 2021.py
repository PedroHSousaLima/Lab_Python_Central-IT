...
caminho = "C:\\Dados_Citsmart\\Consulta\\Criado\\TI\\IGESDF\\"
...
path = f'C:\\Dados_Citsmart\\Consulta\\Criado\\TI\\IGESDF\\'
...
CREDENCIAIS = {
     ...
     "IGESDF": {
        "link_acesso": 'https://cit.igesdf.org.br/citsmart/services/login',
        "link_dados": 'https://cit.igesdf.org.br/citsmart/services/data/query',
        "login": 'citsmart.local\webservice_igesdf',
        "senha": '!@webservice@!'},
    ...
    try:
        ...
        reg = reg[
            ['solicitacao', 'tipo demanda servico', 'situacao', 'solicitante', 'contrato', 'data hora solicitacao', 'SLA',
             ...
             'primeira captura',
             'nota satisfacao','slaatrasado','pf_criador','pf_tecnico','catalogo', 'id grupo executor', 'id grupo criador','observacoestecnico','observacoescriador','prioridade','titulosla']]
