...
caminho = "C:\\Dados_Citsmart\\Consulta\\Encerrado\\TI\\SME\\"

datafim = str(datetime.now() - timedelta(days=1))[0:10] + " 00:00:00"
datafim1 = str(datetime.now() - timedelta(days= 0))[0:10] + " 23:59:59"


path = f'C:\\Dados_Citsmart\\Consulta\\Encerrado\\TI\\SME\\'
...
for contrato in contratos:
    ...
    try:
        solicitacao = obter_dados(nomeTabela=f'solicitacao_{contrato}', queryName='SOLICITACAOSME', session=sessionID,
