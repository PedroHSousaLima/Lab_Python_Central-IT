...
caminho = "E:\\REPOSITORIO\\OneDrive - CENTRAL IT TECNOLOGIA DA INFORMAÇÃO LTDA\\Área de Trabalho\\Dados_Citsmart\\Criado\\"
...
path = f'E:\\REPOSITORIO\\OneDrive - CENTRAL IT TECNOLOGIA DA INFORMAÇÃO LTDA\\Área de Trabalho\\Dados_Citsmart\\Criado\\'
#path2 = f'C:\\Dados_Citsmart\\Consolidado\\Criado\\2020\\Novembro\\'
path2 = f'E:\\REPOSITORIO\\OneDrive - CENTRAL IT TECNOLOGIA DA INFORMAÇÃO LTDA\\Repositorio_Date\\DADOS\\CISTMART\\CSV\\CONSOLIDADO\\{ano}\\{mes}\\'
...
CREDENCIAIS = {
    ...
    "PF": {
        "link_acesso": 'https://atendimento.pf.gov.br/citsmart/services/login',
        "link_dados": 'https://atendimento.pf.gov.br/citsmart/services/data/query',
        "login": 'citsmart.local\webservice_pf',
        "senha": '!@webservice@!'},
...
for z in conjunto:
    try:
        ...
        reg.to_csv(f'{path2}criado_{nome}- {mes} - {ano}.csv', sep=';', encoding='utf-8-sig', index=False)
