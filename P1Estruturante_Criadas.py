...
caminho = "C:\\Dados_Citsmart\\Consulta\\Criado\\Estruturantes\\P1\\"
...
path = f'C:\\Dados_Citsmart\\Consulta\\Criado\\Estruturantes\\P1\\'
...
CREDENCIAIS = {
    ...
    "ESTRUTURANTES-IP2-01-15": {
        ...
        "link_acesso": 'https://portaldeservicos.economia.gov.br/citsmart/services/login',
        "link_dados": 'https://portaldeservicos.economia.gov.br/citsmart/services/data/query',
        "login": 'citsmart.local\webservice_estruturantes',
        "senha": '!@webservice@!'},
...
for z in conjunto:
    try:
        ...
        reg = reg[
             ...
             'primeira captura',
             'nota satisfacao', 'slaatrasado', 'pf_criador', 'pf_tecnico', 'catalogo','observacoescriador','observacoestecnico']]
