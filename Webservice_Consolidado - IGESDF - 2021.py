...
caminho = "C:\\Dados_Citsmart\\Consulta\\Encerrado\\TI\\IGESDF\\"
...
path = f'C:\\Dados_Citsmart\\Consulta\\Encerrado\\TI\\IGESDF\\'
    ...
    try:
        ...
        reg = reg[
            ['solicitacao', 'tipo demanda servico', 'situacao', 'solicitante', 'contrato', 'data hora solicitacao', 'SLA',
             ...
             'primeira captura',
             'nota satisfacao','slaatrasado','pf_criador','pf_tecnico','catalogo','id grupo executor','id grupo criador','observacoescriador','observacoestecnico','prioridade','titulosla']]
