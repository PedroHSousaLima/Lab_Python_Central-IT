...
caminho = "C:\\Dados_Citsmart\\Consulta\\Criado\\TI\\MJ\\"
...
path = f'C:\\Dados_Citsmart\\Consulta\\Criado\\TI\\MJ\\'
...
CREDENCIAIS = {
     ...
     "MJSP": {
        "link_acesso": 'https://citsmart.mj.gov.br/citsmart/services/login',
        "link_dados": 'https://citsmart.mj.gov.br/citsmart/services/data/query',
        "login": 'citsmart.local\webservice_mjsp',
        "senha": '!@webservice@!'},
...
for z in conjunto:
    try:
        ...
        reg = reg[
            ['solicitacao', 'tipo demanda servico', 'situacao', 'solicitante', 'contrato', 'data hora solicitacao', 'SLA',
             ...
             'primeira captura',
             'nota satisfacao','slaatrasado','pf_criador','pf_tecnico','catalogo', 'id grupo executor', 'id grupo criador','prioridade', 'idnota','grupesquisa','titulosla',
             'observacoescriador', 'observacoestecnico'
             ]]
